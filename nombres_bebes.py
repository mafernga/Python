# -*- coding: utf-8 -*-
"""
Created on Tue Jul 21 07:15:20 2020
...
def parsear_argumentos_avanzado():
    parser=argparse.ArgumentParser(
        description="""Este script calcaula el numero de años desde 2002 que el nombre indicado fue
                    de los mas populares en españa"""
...
def main(argumentos):
    ...
    print("El nombre {} está entre los mas populares en {} años".format(nombre, years_nombre))
